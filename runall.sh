...
echo ------
java -cp a2.jar ece454750s15a2.TriangleCount -ncores 2 -if inputs/graph1M_B.txt -of output.txt
perl sorted/sort.pl output.txt > new_list
echo ------
diff new_list sorted/graph1M_B
echo ------
java -cp a2.jar ece454750s15a2.TriangleCount -ncores 2 -if inputs/graph100K_C.txt -of output.txt
perl sorted/sort.pl output.txt > new_list
echo ------
diff new_list sorted/graph100K_C
echo ------
java -cp a2.jar ece454750s15a2.TriangleCount -ncores 2 -if inputs/graph10K_C.txt -of output.txt
perl sorted/sort.pl output.txt > new_list
echo ------
